...
const HealthAssistant = () => {
  ...
  return (
    <div className="container mx-auto flex h-screen flex-col md:flex-row">
      <div className="left w-full md:w-1/2 bg-white flex flex-col justify-center p-8">
        ...
        <form className="form space-y-4" onSubmit={handleSubmit}>
          ...
          <button
            type="submit"
            className="w-full bg-gradient-to-r from-pink-500 to-blue-500 text-white py-2 rounded"
          >
            Calculate
          </button>
        </form>
      </div>
      <div className="right w-full md:w-1/2 bg-white flex flex-col justify-center p-8">
        {metrics ? (
          <div className="metrics p-4 relative">
            ...
            {Object.keys(metrics).map((metric) => {
              ...
              return (
                <div
                  key={metric}
                  className="mb-2 flex items-center group border-2 rounded p-2 px-4"
                >
                  ...
                  <span className="relative ml-4">
                    ...
                    <span className="absolute right-0 top-full transform -translate-y-2 p-2 text-xs bg-gray-700 text-white rounded opacity-0 group-hover:opacity-100 transition-opacity">
          ...
          <div
            className="right md:w-1/2 bg-black bg-cover bg-center"
            style={{
              background:
                "url('https://blog.ipleaders.in/wp-content/uploads/2020/01/Health-Insurance.jpg'),transparent",
