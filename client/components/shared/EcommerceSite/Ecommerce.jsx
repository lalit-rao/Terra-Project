  ...
  useEffect(() => {
    const fetchProducts = async () => {
      const options = {
        ...
        headers: {
          "x-rapidapi-key": "d2c3d2f471msh515b08e24ff0115p1c83e0jsndb5ad18e7a9f",
  ...
  return (
    <div className=" text-center bg-[#F3F3F3] mt-20">
      ...
      <div className="pt-15 relative h-[100vh] flex items-center place-content-center flex-col gap-10">
        ...
        <div className="">
          <Image src={tree1} alt="" className="absolute top-0 left-0 h-40 md:h-80 " />
          <Image src={tree2} alt="" className="absolute left-0 bottom-0 h-20 md:h-80" />
          <Image src={tree3} alt="" className="absolute right-0 bottom-0 h-10 lg:h-52" />
          <Image src={tree4} alt="" className="absolute right-0 top-0 h-18 md:h-full" />
          <Image src={tree5} alt="" className="absolute bottom-0 right-1/2 h-20 md:h-52" />
        </div>
      </div>
      ...
      <div className="flex justify-center text-center h-[90vh] place-content-center">
        <div className="w-[45vw] text-left flex flex-col place-content-center gap-2 md:gap-5">
          <h1 className="text-sm md:text-4xl font-bold text-[#191A23]">Why choose us?</h1>
          ...
          <div className="text-[10px] md:text-2xl text-[#8A868C] flex flex-col gap-3">
            <Fade>
              <p>
                🌱<b>Global Selection:</b> Access a diverse range of sustainable products
                sourced from 22 countries, ensuring quality and variety for every
                eco-conscious shopper.
              </p>
            </Fade>
            <Fade>
              <p>
                🌵<b>Informed Shopping:</b> Make confident purchasing decisions with
                comprehensive product details highlighting eco-friendly features and
                benefits.
              </p>
            </Fade>
            <Fade>
              <p>
                ☘️<b>Convenient Experience:</b> Enjoy seamless shopping with easy
                navigation and direct links, making sustainable choices hassle-free and
                accessible.
              </p>
            </Fade>
          </div>
      ...
      <div>
        ...
        <div className=" flex justify-center gap-4">
          ...
          <FilterCard variableFunc={setRate} Name="rate" variable={rate} label="Rating 3.5+" />
          <FilterCard
            ...
            filteredData.map((product) => (
              <Fade key={product.product_url}>
                <div
                  className="flex flex-wrap justify-around m-2 md:m-7 relative gap-2 md:gap-4"
                >
                  {product.is_prime && <p className="absolute top-0 left-0">Amazon Prime</p>}
                  <Card
                    title={product.product_title}
                    product_photo={product.product_photo}
                    star_rating={product.product_star_rating}
